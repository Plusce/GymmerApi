...
{
    public static readonly TrainingValidationMessages TrainingDefinitionNameDoesNotExists =
    ...
    public static readonly TrainingValidationMessages IncorrectExerciseOptionNames =
        new("Some of the provided exercise option names do not exist in the database.");
}